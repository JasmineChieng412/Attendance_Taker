...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const IntroductionScreen()//const MakeDashboardItems(), // AttendanceRecord(),
    );
  }
}
...
/*
  final List<Users> userList = [
   // Users(id: '1', name: 'Jason', checkIn: DateTime.now()),
    Users(phone: '1', name: 'Ben', checkIn: DateTime.now()),
    Users(phone: '2', name: 'Will', checkIn: DateTime.now()),
       ...
       return Card(
         child: Row(
           children: [
             ...
             Container(
               margin: EdgeInsets.all(5),
                //DateTime minAgo =  user.checkIn.subtract(const Duration(minutes: 1));
               child: Text(user.checkIn.toString()),
              //child: Text(timeAgo.format(minAgo)),
             ),
           ],
         ),
        );
